...
class Gallery extends admin {
	...
	*/
	...
	function add_gallery()
	{
		...
		$this->form_validation->set_rules('gallery_name', 'Title', 'required|trim|xss_clean');
		$this->form_validation->set_rules('department_id', 'Department', 'required|trim|xss_clean');
